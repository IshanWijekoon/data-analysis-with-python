...
def calculate_demographic_data(print_data=True):
    ...
    country_earning_pct = (
        df.groupby("native-country")["salary"].apply(lambda s: (s == ">50K").mean())
        * 100
    )
    highest_earning_country = country_earning_pct.idxmax()
    highest_earning_country_percentage = round(country_earning_pct.max(), 1)
